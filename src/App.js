...
function App() {
  ...
  {/* Featured Product */}
  <div className="absolute right-4  md:top-28 sm:right-6  bg-white pt-10 shadow-xl ring-1 h-[330px] w-64 sm:w-80 ring-gray-900/5 mx-auto sm:max-w-lg sm:rounded-2xl z-10">
    ...
    <div className="flex flex-col items-center space-y-4 mt-4">
      ...
      <p className="text-sm font-thin text-gray-400 text-center">
        ...
        <div className="w-full flex justify-end  h-24 pr-16">
